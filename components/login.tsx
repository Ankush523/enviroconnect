...
import {
  Box, VStack, Heading, Button, Input, FormControl, FormLabel, useToast, Flex, Image, InputGroup, InputRightElement, Avatar
...
const Login = () => {
  ...
  return (
    <Flex h="100vh" alignItems="center" justifyContent="center" bgGradient="linear(to-r, blue.900, blue.200)">
...
<Button colorScheme="red" w="full" onClick={() => { 
  setIsAuthorityLogin(true); 
  setIsUserLogin(false); 
}}>Login as Authority</Button>
          ...
          {isUserLogin ? (
            <VStack spacing={4} w="full">
              <FormControl isRequired>
                ...
                <Input value={aadharNumber} onChange={(e) => setAadharNumber(e.target.value)} placeholder="Enter Aadhar Number" />
              </FormControl>
              <FormControl isRequired>
              ...
              <Link href="/homepage">
                <Button colorScheme="green" w="full" onClick={handleUserSubmit}>Submit</Button>
              </Link>
            </VStack>
          ) : isAuthorityLogin ? (
            <VStack spacing={4} w="full">
              <FormControl isRequired>
                ...
                <Input value={authorityId} onChange={(e) => setAuthorityId(e.target.value)} placeholder="Enter Authority ID" />
              </FormControl>
              <Button colorScheme="green" w="full" onClick={handleAuthoritySubmit}>Submit</Button>
            </VStack>
          )
        :
        null}
